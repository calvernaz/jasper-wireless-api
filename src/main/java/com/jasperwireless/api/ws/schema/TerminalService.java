 ...
 *
 */
@WebServiceClient(name = "TerminalService", targetNamespace = "http://api.jasperwireless.com/ws/schema", wsdlLocation = "http://api.jasperwireless.com/ws/schema")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://api.jasperwireless.com/ws/schema/Terminal.wsdl");
