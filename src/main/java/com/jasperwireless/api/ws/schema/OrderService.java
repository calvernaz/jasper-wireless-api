 ...
 *
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://api.jasperwireless.com/ws/schema", wsdlLocation = "http://api.jasperwireless.com/ws/schema/Order.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://api.jasperwireless.com/ws/schema/Order.wsdl/Order.wsdl");
