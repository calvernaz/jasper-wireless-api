 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://api.jasperwireless.com/ws/schema", wsdlLocation = "file:/Users/calvernaz/sandbox/github-modules/jasperwireless-api/src/main/resources/Order.wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://api.jasperwireless.com/ws/schema", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/calvernaz/sandbox/github-modules/jasperwireless-api/src/main/resources/Order.wsdl");
    ...
    public OrderPortType getOrderPort() {
        return super.getPort(new QName("http://api.jasperwireless.com/ws/schema", "OrderPort"), OrderPortType.class);
    }
    ...
    public OrderPortType getOrderPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.jasperwireless.com/ws/schema", "OrderPort"), OrderPortType.class, features);
    }
