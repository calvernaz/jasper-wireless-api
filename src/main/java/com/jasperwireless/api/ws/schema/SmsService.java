 ...
 *
 */
@WebServiceClient(name = "SmsService", targetNamespace = "http://api.jasperwireless.com/ws/schema", wsdlLocation = "https://api.jasper.com/ws/schema/Sms.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://api.jasper.com/ws/schema/Sms.wsdl");
