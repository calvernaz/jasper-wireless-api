 ...
 *     
 * 
 * <p>Java class for SimImeiMismatchInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SimImeiMismatchInfoType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="iccid" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="networkImei" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="customerImei" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "SimImeiMismatchInfoType", propOrder = {
    "iccid",
    "networkImei",
    "customerImei",
    "dateChanged",
...
@XmlSeeAlso({
    SimImeiMismatch.class
})
public class SimImeiMismatchInfoType {

    @XmlElement(required = true)
    protected String iccid;
    @XmlElement(required = true)
    protected String networkImei;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the networkImei property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getNetworkImei() {
        return networkImei;
    }

    /**
     * Sets the value of the networkImei property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setNetworkImei(String value) {
        this.networkImei = value;
    }
