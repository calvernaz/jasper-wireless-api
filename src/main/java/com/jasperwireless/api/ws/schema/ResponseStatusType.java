 ...
 *         &lt;element name="message" type="{http://api.jasperwireless.com/ws/schema}ResponseMessageType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ResponseStatusType {
    ...
    protected List<ResponseMessageType> message;
     ...
     * 
     */
    public List<ResponseMessageType> getMessage() {
        if (message == null) {
            message = new ArrayList<ResponseMessageType>();
        }
        return this.message;
    }
