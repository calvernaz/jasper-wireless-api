 ...
 *
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://api.jasperwireless.com/ws/schema", wsdlLocation = "http://api.jasperwireless.com/ws/schema/Account.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://api.jasperwireless.com/ws/schema/Account.wsdl");
