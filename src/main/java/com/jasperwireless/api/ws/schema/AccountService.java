 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://api.jasperwireless.com/ws/schema", wsdlLocation = "file:/Users/calvernaz/sandbox/github-modules/jasperwireless-api/src/main/resources/Account.wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://api.jasperwireless.com/ws/schema", "AccountService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/calvernaz/sandbox/github-modules/jasperwireless-api/src/main/resources/Account.wsdl");
    ...
    public AccountPortType getAccountPort() {
        return super.getPort(new QName("http://api.jasperwireless.com/ws/schema", "AccountPort"), AccountPortType.class);
    }
    ...
    public AccountPortType getAccountPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.jasperwireless.com/ws/schema", "AccountPort"), AccountPortType.class, features);
    }
